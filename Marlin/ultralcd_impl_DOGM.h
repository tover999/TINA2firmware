...
#define FONT_NAME_RU		ISO10646_5_Cyrillic_5x7
...
#ifndef DISPLAY_CHARSET_ISO10646_5
...
static void lcd_setFont(const char font_nr) {
 ...
 // }
	...
	{
		switch (font_nr) {
		case FONT_STATUSMENU: {u8g.setFont(FONT_NAME_RU); currentfont = FONT_STATUSMENU; }; break;
		case FONT_MENU: {u8g.setFont(FONT_NAME_RU); currentfont = FONT_MENU; }; break;
		case FONT_SPECIAL: {u8g.setFont(FONT_SPECIAL_NAME); currentfont = FONT_SPECIAL; }; break;
		case FONT_MENU_EDIT: {u8g.setFont(FONT_NAME_RU); currentfont = FONT_MENU_EDIT; }; break;
			break;
		}
	}
	else
...
void lcd_implementation_clear() { } // Automatically cleared by Picture Loop
  ...
  static void lcd_implementation_drawmenu_var(const bool isSelected, const uint8_t row, const char* pstr, const char* vstr, const char pre_char, const char post_char) {
	  UNUSED(pre_char);
